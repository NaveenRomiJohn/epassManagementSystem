...
<body>
	<ul class="topnav">
		...
		<li><a href="/home/userloggedin?userId=${userId1}">User</a></li>
		<li><a class="active" href="/epass/epassformtype?userId=${userId1}">EpassForm</a></li>
		...
		<div id="epassform">
			...
			<form:form action="/epass/epassformwithinregistered" method="post"
				...
				<table class="center"><caption></caption>
					<tr>
						<td><form:hidden path="userId" value="${userId1}"/></td>
					</tr>
					<tr>
